...
export default function SalesManagerPage() {
  ...
  const orderValue = selectedOrder?.total || 0
  ...
  return (
    <RoleOverviewLayout
      ...
      description="Review every backend order, open specific order details by order number, download invoices, and move orders through the fulfillment statuses."
    >
          ...
          <section className="aurora-summary-strip">
            <div className="aurora-summary-lead p-6">
              <div className="aurora-widget-body">
                ...
                <p className="text-sm leading-7 text-[var(--aurora-text)]">
                  Loaded from <span className="font-semibold">GET /api/orders?admin=1</span>.
                </p>
              </div>
            </div>
            ...
            <div className="aurora-summary-card p-6">
              <div className="aurora-widget-body">
                ...
                <p className="text-sm leading-7 text-[var(--aurora-text)]">
                  All orders visible to Admin and Sales Manager tokens.
                </p>
              </div>
            </div>
            ...
            <div className="aurora-summary-card p-6">
              <div className="aurora-widget-body">
                ...
                <p className="text-sm leading-7 text-[var(--aurora-text)]">
                  Orders completed through the delivery state.
                </p>
              </div>
            </div>
            ...
            <div className="aurora-summary-card p-6">
              <div className="aurora-widget-body">
                <div className="aurora-widget-heading">
                  ...
                  <p className="mt-3 font-display text-3xl text-[var(--aurora-text-strong)]">
                    {selectedOrder ? formatCurrency(orderValue) : '—'}
                  </p>
                </div>
                <p className="text-sm leading-7 text-[var(--aurora-text)]">
                  Full pricing appears after selecting an order.
                </p>
              </div>
            </div>
          </section>
              ...
              <div className="mt-8 space-y-4">
                {orders.map((order) => {
                  ...
                  return (
                    <article
                      key={order.id}
                      className={`aurora-ops-card p-5 ${selected ? 'ring-2 ring-[var(--aurora-sky-deep)]' : ''}`.trim()}
                    >
                      <button
                        type="button"
                      ...
                      >
                        <div className="aurora-widget-header">
                          <div className="aurora-widget-heading">
                            <p className="break-all text-xs font-semibold uppercase tracking-[0.18em] text-[var(--aurora-olive-deep)]">
                              {order.id}
                            </p>
                          ...
                          <div className="text-sm text-[var(--aurora-text)] sm:text-right">
                            ...
                            <span className={`aurora-order-status-chip is-${status.key} mt-2 inline-flex`}>
                              {status.label}
                            </span>
                          </div>
                        </div>
            ...
            <div className="aurora-widget-body">
              ...
              {selectedOrder ? (
                <>
                  ...
                  <div className="aurora-widget-subsurface p-5">
                    <label
                      htmlFor="sales-manager-order-status"
                      className="text-xs font-semibold uppercase tracking-[0.24em] text-[var(--aurora-olive-deep)]"
                    >
                      Update status
                    </label>
                    <select
                  ...
                  <div className="aurora-widget-subsurface p-5">
                    ...
                    <div className="mt-4 space-y-3">
                      {selectedOrder.items.map((item) => (
                        <div key={`${item.lineItemId || item.productId}:${item.variantId || item.variantCode || item.name}`} className="flex items-start justify-between gap-4 text-sm">
                          <div>

...
function normalizeProduct(rawProduct) {
  ...
  return {
    ...
    model: normalizeText(rawProduct.model),
    serialNumber: normalizeText(rawProduct.serial_number ?? rawProduct.serialNumber),
    ...
    isWishlisted: toBoolean(rawProduct.is_wishlisted ?? rawProduct.isWishlisted),
    options: optionGroups,
    variants,
    discountRate: toNullableNumber(rawProduct.discount_rate ?? rawProduct.discountRate) ?? 0,
    warrantyStatus: normalizeText(rawProduct.warranty_status ?? rawProduct.warrantyStatus),
    distributorInformation: normalizeText(
      rawProduct.distributor_information ?? rawProduct.distributorInformation,
    ),
...
function mergeProductRecord(existingProduct, incomingProduct) {
  ...
  return {
    ...
    model: incomingProduct.model || existingProduct.model,
    serialNumber: incomingProduct.serialNumber || existingProduct.serialNumber,
    ...
    isWishlisted: incomingProduct.isWishlisted ?? existingProduct.isWishlisted,
    ...
    warrantyStatus: incomingProduct.warrantyStatus || existingProduct.warrantyStatus,
    distributorInformation:
      incomingProduct.distributorInformation || existingProduct.distributorInformation,
